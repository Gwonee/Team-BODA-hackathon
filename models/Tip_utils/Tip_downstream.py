...
if __name__ == "__main__":
  args = DotDict({'model': 'resnet50', 'checkpoint': None, 
                  'num_cat': 6, 'num_con': 11, 'num_classes': 1, 
                  'field_lengths_tabular': '/data/ephemeral/home/data/base_features/tabular_lengths_all_views_reordered.pt',
                  'tabular_embedding_dim': 512, 'tabular_transformer_num_layers': 4, 'multimodal_transformer_layers': 4,'embedding_dropout': 0.0, 'drop_rate':0.0,
                    ...
                    'imaging_pretrained': True, 'imaging_pretrained_name': 'deit_small_patch16_224-cd65a155.pth', 'imaging_pretrained_path':'/data/ephemeral/home/data/pretrained',
