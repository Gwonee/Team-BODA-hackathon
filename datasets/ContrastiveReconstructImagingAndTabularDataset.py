...
if __name__ == '__main__':
  dataset = ContrastiveReconstructImagingAndTabularDataset(
    data_path_imaging='/data/ephemeral/home/data/base_features/val_paths_all_views.pt', delete_segmentation=False, augmentation=transforms.Compose([transforms.Resize(size=(128,128)),transforms.Lambda(convert_to_float)]), augmentation_rate=0.5,
    data_path_tabular='/data/ephemeral/home/data/base_features/dvm_features_val_noOH_all_views_reordered.csv', corruption_rate=0.15, replace_random_rate=0.0, replace_special_rate=0.50, 
    field_lengths_tabular='/data/ephemeral/home/data/base_features/tabular_lengths_all_views_reordered.pt', one_hot_tabular=False,
    labels_path='/data/ephemeral/home/data/base_features/labels_model_all_val_all_views.pt', img_size=128, live_loading=True, augmentation_speedup=False
  )
  a = list(range(17))
  x = dataset[3]