...
if __name__ == '__main__':
  dataset = TabularDataset(data_path='path/your/own/file',
                           eval_train_augment_rate=1.0, labels_path='path/your/own/file',
                           corruption_rate=0.3, train=True, eval_one_hot=False,
                           field_lengths_tabular='path/your/own/file',
                           data_base='path/your/own/file',
