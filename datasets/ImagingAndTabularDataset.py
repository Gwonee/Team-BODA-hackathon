...
if __name__ == '__main__':
  dataset = ImagingAndTabularDataset(
    data_path_imaging='/data/ephemeral/home/data/base_features/val_paths_all_views.pt', delete_segmentation=False, eval_train_augment_rate=0.8, 
          data_path_tabular='/data/ephemeral/home/data/base_features/dvm_features_val_noOH_all_views_reordered.csv', 
          field_lengths_tabular='/data/ephemeral/home/data/base_features/tabular_lengths_all_views_reordered.pt', eval_one_hot=False,
          labels_path='/data/ephemeral/home/data/base_features/labels_model_all_val_all_views.pt', img_size=128, live_loading=True, train=True, target='dvm',
          corruption_rate=0.3, data_base='/data/ephemeral/home/data/base_features', missing_tabular=True, 
