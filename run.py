...
def run(args: DictConfig):
  ...
  if args.use_wandb:
    ...
    wandb_logger = WandbLogger(name=exp_name, project='test_code', entity=args.wandb_entity, save_dir=base_dir, offline=args.offline)
...
@hydra.main(config_path='./configs', config_name='config_dvm_TIP', version_base=None)
